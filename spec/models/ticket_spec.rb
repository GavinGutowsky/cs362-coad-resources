...
RSpec.describe Ticket, type: :model do
  ...
  describe 'scopes' do
    ...
    describe 'open' do
      it 'contains open tickets that do not belong to an organization' do
        expect(Ticket.open).to include(open_nil_ticket)
      end

      it 'does not contain open tickets that belong to an organization' do
    ...
    describe 'all_organization' do
      it 'contains open tickets that belong to an organization' do
      ...
      it 'does not contain open tickets that do not belong to an organization' do
        expect(Ticket.all_organization).to_not include(open_nil_ticket)
      end
    end

    describe 'organization' do
      it 'contains open tickets that belong to a given organization' do
      ...
      it 'does not contain closed tickets that belong to a given organization' do
      ...
      it 'does not contain tickets that do not belong to a given organization' do
        organization = open_organization_ticket.organization
    ...
    describe 'closed_organization' do
      it 'contains closed tickets that belong to a given organization' do
        organization = closed_organization_ticket.organization
        expect(Ticket.closed_organization(organization.id)).to include(closed_organization_ticket)
      end

      it 'does not contain open tickets that belong to a given organization' do
        organization = open_organization_ticket.organization
    ...
    describe 'region' do
      it 'contains tickets that belong to a given region' do
        region = open_ticket.region
        expect(Ticket.region(region.id)).to include(open_ticket)
      end

      it 'does not contain tickets that do not belong to a given region' do
        region = open_ticket.region
    ...
    describe 'resource_category' do
      it 'contains tickets that belong to a given resource_category' do
      ...
      it 'does not contain tickets that do not belong to a given resource_category' do
        resource_category = open_ticket.resource_category
